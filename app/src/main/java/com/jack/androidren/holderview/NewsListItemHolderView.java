package com.jack.androidren.holderview;
...
import com.jack.androidren.adapters.NewsListAdapter;
 ...
 */
public class NewsListItemHolderView extends MaterialRippleLayout {
    ...
    public NewsListItemHolderView(Context context) {
        super(context);
    }

    public NewsListItemHolderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NewsListItemHolderView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        this.news_title = (TextView) findViewById(R.id.news_time);
